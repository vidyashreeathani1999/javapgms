public class LuceneSearchUtil {
    ...
    private static final String SEARCH_SQL = "SELECT * FROM Error1 WHERE rowID";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (Statement stmt = conn.createStatement();
            ...
            while (rs.next()) {
                luceneSearch.addDocument(rs.getInt("rowID"),rs.getString("Description"));
            }
        }
        ...
        for (String result : searchResults) {
            System.out.println("Display search result"+result);
        }
...
public class DBManager {
    ...
    private static final String SEARCH_SQL_HQ = "SELECT * FROM Error1 WHERE rowID IN (";
    ...
    public static ResultSet createConAndExecuteQuery(List<String> rowIDList) throws SQLException {
        ...
        System.out.println("Executing query: " + thisSearchQuery);
        System.out.println("With parameters: " + rowIDList.size());
        System.out.println("RowID values ="+rowIDList.get(0));
        System.out.println("RowID values ="+rowIDList.get(1));
        ...
        try (PreparedStatement statement = connection.prepareStatement(thisSearchQuery)) {
            ...
            if (!resultSet.isBeforeFirst()) {
                ...
                System.out.println("Result set contains data.");
            }
        ...
        if (resultSet !=null) {
            ...
            try {
                while (resultSet.next()) {
                    ...
                    thisErrorAssistTO.cause = resultSet.getString("Cause");
...
/*
                if(rowIDList.isEmpty()){
                    System.out.println("No results found in Lucene search");
                    return  resultList;
                }
                System.out.println("Row IDs from Lucene search: "+ rowIDList);


 */
                //Filter and conver  wrow IDs to valid int
                List<Integer> validRowIDList = rowIDList.stream().filter(rowID ->{
                    try{
                ...
                if(validRowIDList.isEmpty()){
                    System.out.println("No valid row IDs found.");
                    return resultList;
                }
                System.out.println("Valid Row IDs: "+ validRowIDList);
              ...
              /*  if(resultSet==null){
                    System.out.println("No results found in database query");
                    return resultList;
                }
               ...
               */
               ...
               // ArrayList<ErrorAssistTO> errorAssitTOList = ErrorAssistTranformer.transformResultToEntity(resultSet);
                ...
                if(resultList.isEmpty()){
                    ...
                    for (ErrorAssistTO item : resultList){
            ...
            System.out.println("Search and retrive results: "+ resultList);
            return resultList;
        }
